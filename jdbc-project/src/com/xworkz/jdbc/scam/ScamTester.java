...
public class ScamTester {
	...
	public static void main(String[] args) {
		...
		try (Connection connection = DriverManager.getConnection(url, userName, password)) {
			...
			String query7 = "insert into scam_table values(8,'Railgate Scam','Indian Railway Board',2012,' Pawan Kumar Bansal',7,'India','Former Railway Minister Pawan Kumar Bansal's nephew Vijay Singla and six others were today denied bail in the Rs 10 crore cash-for-post railway bribery case by a Delhi court, which said that they can tamper with the evidence or influence witnesses, if released on bail. ')";
			String query8 = "insert into scam_table values(9,'Harshad Mehta scam','Bank',1992,'Harshad Mehta',5000,'Mumbai','Harshad Mehta discovered a loophole in this system which would make him the king of Indian stock markets. Since he had become a prominent name in the stock markets by then, he convinced banks to issue him cheques in his own name for buying and selling the BRs.')";
			...
			String query10 = "insert into scam_table values(11,'Chopper Scam','Helicaptors',2013,'Santosh Bagrodia, Satish Bagrodia',3.8,'Italy','The Augusta WestlandVVIP chopper fraud is a bribery case in which it is claimed that bribes were paid to middlemen, maybe even politicians, when India agreed to buy 12 Augusta Westland helicopters from the Italian Defence Corporation, Finmeccanica, for Rs 3,600 crore.')";
